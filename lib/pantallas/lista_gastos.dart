...
import 'package:stock/pantallas/carga_gasto.dart';

class Lista_gastos extends StatefulWidget {
  const Lista_gastos({Key? key}) : super(key: key);

  @override
  _Lista_gastosState createState() => _Lista_gastosState();
}

class _Lista_gastosState extends State<Lista_gastos> {
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => Carga_gasto()));
          },
                    ...
                    onTap: () async {
                      ...
                      return showDialog<void>(
                          ...
                          builder: (BuildContext context) {
                            //String fecha = filtrado[index].fecha;
